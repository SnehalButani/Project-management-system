...
const sendInvitePeople = async ({ email, password }, res) => {

  let mailoption = {
    from: process.env.node_USER,
    to: email,
    subject: "Admin invited you to join them in Jira Software",
    html: `<html>
        <head>
                      ...
                      <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                        ...
                        <tr>
                          <td class="email-masthead">
                            <a href="https://www.hmrtechnologies.com" class="f-fallback email-masthead_name">
                              <img src="https://www.hmrtechnologies.com/_next/static/media/logo.b14714aa.svg"/>
                          </a>
                          </td>
                        </tr>
                        <tr>
                      ...
                      <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                          <td class="content-cell" align="center">
                            <p class="f-fallback sub align-center">Copyright &copy; 2023 | HMR Technologies | All Rights Reserved.</p>
                          </td>
                        </tr>
                      </table>
                    </td>
